...
import { CodeNotebookPanel } from "./CodeNotebookPanel";
        ...
        >
          <>
            ...
            {sideBarMode === "PARTICIPANTS" ? (
              ...
              <WhiteboardPanel panelHeight={panelHeight} />
            ) : sideBarMode === "CODE_NOTEBOOK" ? (
              <CodeNotebookPanel panelHeight={panelHeight} />
            ) : null}
          </>
        </div>
      </div>
