...
import CodeNotebookIcon from "../../icons/Bottombar/CodeNotebookIcon";
...
export function BottomBar({ bottomBarHeight, setIsMeetingLeft }) {
  ...
  const WhiteboardBTN = ({ isMobile, isTab }) => {
    return isMobile || isTab ? (
      <MobileIconButton
        ...
        Icon={WhiteboardIcon}
        isFocused={sideBarMode === sideBarModes.WHITEBOARD}
        onClick={() => {
          setSideBarMode((s) =>
            s === sideBarModes.WHITEBOARD ? null : sideBarModes.WHITEBOARD
          );
        }}
      />
    ) : (
  ...
  const CodeNotebookBTN = ({ isMobile, isTab }) => {
    return isMobile || isTab ? (
      <MobileIconButton
        tooltipTitle={"Code Notebook"}
        buttonText={"Code Notebook"}
        Icon={CodeNotebookIcon}
        isFocused={sideBarMode === sideBarModes.CODE_NOTEBOOK}
        onClick={() => {
          setSideBarMode((s) =>
            s === sideBarModes.CODE_NOTEBOOK ? null : sideBarModes.CODE_NOTEBOOK
          );
        }}
      />
    ) : (
  ...
  const otherFeatures = [
    ...
    { icon: BottomBarButtonTypes.CODE_NOTEBOOK },
                        ...
                        return (
                          ...
                          >
                            {icon === BottomBarButtonTypes.RAISE_HAND ? (
                              ...
                              <CodeNotebookBTN isMobile={isMobile} isTab={isTab} />
                            ) : null}
                          </div>
                        );
                      })}
