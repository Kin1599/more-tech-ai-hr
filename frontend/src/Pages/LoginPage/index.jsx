...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Проверяем localStorage перед логином:', localStorage.getItem('redirectAfterLogin'));
      const result = await login(email, password);
      console.log('Проверяем localStorage после логина:', localStorage.getItem('redirectAfterLogin'));
      ...
      if (result.success) {
        ...
        console.log('Полный результат логина:', result);
